...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="gridPanel" runat="server" BorderStyle="Solid" GroupingText="Lista de materias" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Height="196px">
            <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="ID" OnSelectedIndexChanged="gridView_SelectedIndexChanged" Height="170px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DescripcionPlanCarrera" HeaderText="Plan" />
        ...
        <asp:Panel ID="formPanel" runat="server" Height="273px" BorderStyle="Solid" GroupingText="Complete los datos:" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Visible="False" Width="816px">
            <br />
            ...
            <asp:RequiredFieldValidator ID="ValidadorDesc" runat="server" ControlToValidate="descTextBox" ErrorMessage="La descripción no puede ser vacía" ForeColor="#FF3300">*</asp:RequiredFieldValidator>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="hsTotalesLabel" runat="server" Text="Hs Totales: "></asp:Label>
            <asp:TextBox ID="hsTotalesTextBox" runat="server" Width="111px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="ValidadorHsTotales" runat="server" ControlToValidate="hsTotalesTextBox" ErrorMessage="Las horas totales no pueden ser vacías" ForeColor="#FF3300">*</asp:RequiredFieldValidator>
            <br />
            <br />
            <asp:Label ID="hsSemanalesLabel" runat="server" Text="Hs Semanales: "></asp:Label>
            <asp:TextBox ID="hsSemanalesTextBox" runat="server" Width="111px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="ValidadorHsSemanales" runat="server" ControlToValidate="hsSemanalesTextBox" ErrorMessage="Las horas semanales no pueden ser vacías" ForeColor="#FF3300">*</asp:RequiredFieldValidator>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ForeColor="#FF3300" Height="54px" style="margin-top: 0px" Width="810px" />
        </asp:Panel>
