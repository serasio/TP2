...
<body>
    ...
    <div>      
        ...
        <asp:Panel ID="gridPanel" runat="server" BorderStyle="Solid" GroupingText="Lista de planes" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Height="221px">
        ...
        <asp:Panel ID="formPanel" runat="server" Height="181px" BorderStyle="Solid" GroupingText="Complete los datos:" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Visible="False">
            <br />
            ...
            <asp:DropDownList ID="DropDownListEspecialidad" runat="server">
            </asp:DropDownList>           
            <br />
            <br />
        ...
        <asp:Panel ID="formActionsPanel" runat="server" BackColor="#666666" Height="58px" style="margin-top: 0px">
