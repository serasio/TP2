...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="gridPanel" runat="server" BorderStyle="Solid" GroupingText="Lista de cursos" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Height="191px">
        ...
        <asp:Panel ID="formPanel" runat="server" Height="272px" BorderStyle="Solid" GroupingText="Complete los datos:" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Visible="False" Width="816px">
            <br />
            &nbsp;<asp:Label ID="anioCalLabel" runat="server" Text="Año calendario: "></asp:Label>
            <asp:TextBox ID="anioCalTextBox" runat="server" Width="111px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="ValidadorAnioCal" runat="server" ErrorMessage="El año no puede ser vacío." ForeColor="#FF3300" ControlToValidate="anioCalTextBox">*</asp:RequiredFieldValidator>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;
            <asp:Label ID="cupoLabel" runat="server" Text="Cupo: "></asp:Label>
            <asp:TextBox ID="cupoTextBox" runat="server" Width="111px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="ValidadorCupo" runat="server" ErrorMessage="El cupo no puede ser vacío." ForeColor="#FF3300" ControlToValidate="cupoTextBox">*</asp:RequiredFieldValidator>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="comisionLabel" runat="server" Text="Comisión: "></asp:Label>
            <asp:DropDownList ID="DropDownListComision" runat="server" >
            </asp:DropDownList>       
            <br />
            <br />
