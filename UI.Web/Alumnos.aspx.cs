...
namespace UI.Web
{
    public partial class Alumnos : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            {
                this.gridView.DataSource = this.Logic.GetAll(Persona.TiposPersonas.Alumno);
            } 
        ...
        {
            this.Entity = this.Logic.GetOne(id, Persona.TiposPersonas.Alumno);
            ...
            this.DropDownListPlan.Text = this.Entity.PlanEspecialidadDesc;
        }
        ...
        private void LoadEntity (Persona alumno)
        {
            alumno.Nombre = this.txtbNombre.Text;
            alumno.Apellido = this.txtbApellido.Text;
            alumno.Telefono = this.txtbTelefono.Text;
            alumno.Legajo = int.Parse(this.txtbLegajo.Text);
            alumno.FechaNacimiento = DateTime.Parse(this.txtbFechaNac.Text);
            alumno.IDPlan = listplan[DropDownListPlan.SelectedIndex].ID;
            alumno.TipoPersona = Persona.TiposPersonas.Alumno;
        }

        private void SaveEntity(Persona alumno)
        {
