...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="gridPanel" runat="server" BorderStyle="Solid" GroupingText="Lista de comisiones" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Height="197px">
            <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="ID" OnSelectedIndexChanged="gridView_SelectedIndexChanged">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PlanEspDescripcion" HeaderText="Plan" />
        ...
        <asp:Panel ID="formPanel" runat="server" Height="221px" BorderStyle="Solid" GroupingText="Complete los datos:" BackColor="#CCCCCC" Font-Bold="True" Font-Names="Century Gothic" Font-Size="Medium" Visible="False">
            <br />
            ...
            <asp:RequiredFieldValidator ID="ValidadorDesc" runat="server" ErrorMessage="La descripción no puede ser vacía." ForeColor="#FF3300" ControlToValidate="descTextBox">*</asp:RequiredFieldValidator>
            <br />
            <br />
            &nbsp;<asp:Label ID="anioEspLabel" runat="server" Text="Año especialidad: "></asp:Label>
            <asp:TextBox ID="anioEspTextBox" runat="server" Width="111px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="ValidadorAnioEsp" runat="server" ErrorMessage="El año no puede ser vacío." ForeColor="#FF3300" ControlToValidate="anioEspTextBox">*</asp:RequiredFieldValidator>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ForeColor="#FF3300" Height="46px" />
        </asp:Panel>
